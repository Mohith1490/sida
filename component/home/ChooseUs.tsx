        ...
        <>
            <div className="my-8 mx-4 md:my-12 md:mx-12 bg-gray-900 rounded-3xl">
                ...
                <div className="hidden sm:flex flex-col sm:flex-row relative -mt-8 min-h-[480px]">
                    ...
                    <div className="h-[380px] flex flex-col gap-4 w-full sm:w-96 absolute sm:top-12 sm:left-24 p-8 bg-green-200 rounded-2xl">
                    ...
                    <div className="h-[380px] flex flex-col gap-4 opacity-0 w-full sm:w-96 absolute sm:top-12 sm:left-24 p-8 bg-yellow-200 rounded-2xl">
