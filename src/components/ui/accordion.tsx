...
function Accordion({
  ...
  return <AccordionPrimitive.Root data-slot="accordion"  className="border border-gray-300 rounded-lg  px-3 " {...props} />
}
...
function AccordionTrigger({
  ...
  return (
    <AccordionPrimitive.Header className="flex">
      ...
      >
        {children}
        <div className="rounded-sm bg-blue-700 flex items-center justify-center" >
        <Plus className=" text-white  pointer-events-none size-5 shrink-0" />
        </div>
      </AccordionPrimitive.Trigger>
